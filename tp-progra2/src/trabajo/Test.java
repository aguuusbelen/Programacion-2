...
public class Test {
	public static void main(String[] args) {
		...
		e.agregarMegaTrailer("AA444PR", 15000, 100, true, 3, 150, 200, 50);
		e.agregarFlete("AB555MN", 5000, 20, 4, 2, 300);
		e.asignarDestino("AA333XQ", "Mar del Plata");
		e.asignarDestino("AA444PR", "Buenos Aires");
		...
		+" metros cubicos en el transp AA333XQ (trailer)");
		
		volumen = e.cargarTransporte("AA444PR");
		System.out.println("Se cargaron " + volumen
		+" metros cubicos en el transp AA444PR (megatrailer)");
		
		volumen = e.cargarTransporte("AB555MN");
		System.out.println("Se cargaron " + volumen
